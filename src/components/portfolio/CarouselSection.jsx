...
import { brandProjects, carouselImages } from "../DesignsImages";
import { fade } from "./portfolioData";
import PinterestGrid from "./PinterestGrid";
import SectionIntro from "./SectionIntro";

const CarouselSection = (onOpenImage) => {
 return (
    <section id="brands" className="bg-black px-5 py-24 text-white md:pl-24 lg:px-8 lg:pl-28">
      <div className="mx-auto max-w-7xl">
        <SectionIntro eyebrow="Portfolio for brand designs" title="Brand carousel designs." />

        <div className="space-y-16">
          {carouselImages.map((brand, brandIndex) => (
